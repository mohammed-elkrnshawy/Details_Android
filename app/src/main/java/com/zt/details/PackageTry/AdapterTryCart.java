...
public class AdapterTryCart extends RecyclerView.Adapter<AdapterTryCart.ViewHolder> {

    private Context context ;
    private List<ClassTry> offerList ;

    public AdapterTryCart(Context context, List<ClassTry> offerList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.view_cart_item
                , viewGroup , false) ;
